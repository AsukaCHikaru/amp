...
describe('heading', () => {
  ...
  describe('blocks', () => {
    ...
    test('should parse heading levels correctly', () => {
      ...
      const headingBlocks = blocks as import('../lib/definition').HeadingBlock[];
        ...
        body: [
          {
            type: 'textBody',
            style: 'plain',
            value: 'Integer quis nunc sodales, cursus mauris nec, dignissim purus. Nulla id mauris arcu. Phasellus et dui euismod, egestas nibh quis, molestie quam. Donec et metus volutpat, luctus massa ac, tempus velit. Vivamus quis consectetur odio. Ut egestas libero semper efficitur commodo. Integer fermentum odio a vulputate maximus. Nulla at maximus purus.',
          },
        ],
      });
